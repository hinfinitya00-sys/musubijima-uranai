...
| UI-007 | 本番静的JS | 全主要画面 | **未合格**：最新bundleでReact error #419が1件。修正・再配備・再検査中 |
| UI-008 | 320×568 / 390×844 / 768×1024 / 1440×900 / 720×450（200%幅相当） | 公開22ルート×5条件 | 110/110合格。横はみ出し、操作要素・画像の欠け、壊れた画像、異常サイズ画像、文字化け、旧980円、ページ例外、console errorを自動検査 |
